...
import { TColorVariantIndexBlack, TColorVariantIndexDark, 
  TColorVariantIndexDarker, TColorVariantIndexDarkest, TColorVariantIndexLight, 
  TColorVariantIndexLighter, TColorVariantIndexMain, 
...
describe('ColorVarianHelper', function () 
{
  it('getNameByIndex', function (done) 
  {
    ...
    expect(ColorVarianHelper.getNameByIndex(3)).toBe('lighter');
    expect(ColorVarianHelper.getNameByIndex(4)).toBe('light');
    expect(ColorVarianHelper.getNameByIndex(5)).toBe('main');
    expect(ColorVarianHelper.getNameByIndex(6)).toBe('dark');
    expect(ColorVarianHelper.getNameByIndex(7)).toBe('darker');
    expect(ColorVarianHelper.getNameByIndex(8)).toBe('darkest');
    expect(ColorVarianHelper.getNameByIndex(9)).toBe('black');
    done();
  });
  ...
  it('getIndexByName', function (done) 
  {
    expect(ColorVarianHelper.getNextIndex(TColorVariantIndexWhite, 2)).toBe(TColorVariantIndexLighter);
